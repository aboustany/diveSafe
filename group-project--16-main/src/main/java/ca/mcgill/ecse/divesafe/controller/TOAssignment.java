...
public class TOAssignment
{
  ...
  public TOAssignment(String aMemberEmail, String aMemberName, String aGuideEmail, String aGuideName, String aHotelName, int aStartDay, int aEndDay, int aTotalCostForGuide, int aTotalCostForEquipment, String aAuthorizationCode, int aRefund, String aStatus)
  {
