Feature: Setup DiveSafe program information (p10)
  ...
  Scenario Outline: Setup NMC program information with invalid inputs
    When the admin attempts to setup the NMC program information with the start date "<startDate>", number of diving days "<numDays>", and price of guide per day "<priceOfGuidePerDay>" (p10)
